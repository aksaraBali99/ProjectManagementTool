...
<div class="mx-auto max-w-2xl">
    ...
    <div class="mt-10 rounded-[10px] border border-gray-200 bg-gray-50 p-4">
        ...
        <form method="POST" action="{{ route('organizations.toggle-active', $organization) }}" class="mt-3">
            @csrf
            @method('PATCH')
            <button type="submit" class="rounded-[8px] border border-gray-300 bg-white px-3 py-1.5 text-[11px] font-medium text-gray-700 hover:bg-gray-50">

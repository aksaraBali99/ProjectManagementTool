...
<div>
    ...
    <div class="mt-4 inline-flex flex-col rounded-[10px] border border-gray-200 bg-white px-4 py-3">
        <span class="text-[10px] font-semibold uppercase tracking-[0.05em] text-gray-500">Overdue tasks</span>
        <span class="mt-1 text-[24px] font-semibold text-[#A32D2D]">{{ $overdueCount }}</span>
    </div>

    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
        <div class="rounded-[10px] border border-gray-200 bg-white p-3">
            <h2 class="text-[11px] font-semibold uppercase tracking-[0.05em] text-gray-500">Completion rate per company</h2>
        ...
        <div class="rounded-[10px] border border-gray-200 bg-white p-3">
            <h2 class="text-[11px] font-semibold uppercase tracking-[0.05em] text-gray-500">Tasks by status</h2>
        ...
        <div class="rounded-[10px] border border-gray-200 bg-white p-3">
            <h2 class="text-[11px] font-semibold uppercase tracking-[0.05em] text-gray-500">Tasks by priority</h2>
        ...
        <div class="rounded-[10px] border border-gray-200 bg-white p-3">
            <h2 class="text-[11px] font-semibold uppercase tracking-[0.05em] text-gray-500">Staff workload (open tasks)</h2>

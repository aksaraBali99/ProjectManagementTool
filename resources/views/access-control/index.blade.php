...
<div>
    ...
    <p id="access-control-view-only-note" class="mt-2 text-[11px] text-gray-500">
        ...
        <a href="{{ route('users.index') }}" class="text-brand-600 hover:underline">edit an individual user's department access</a> instead.
    </p>
    <p id="access-control-editing-note" class="mt-2 text-[11px] text-brand-700" style="display: none;">
                                    ...
                                    <td class="px-3 py-2 text-center">
                                        <form method="POST" action="{{ route('access-control.toggle') }}" class="inline-flex">
                                            ...
                                            <label class="access-control-toggle-label relative inline-flex cursor-not-allowed items-center opacity-60">
                                                ...
                                                >
                                                <span class="block h-4 w-7 rounded-full bg-[#CCCCCA] transition-colors peer-checked:bg-brand-600"></span>

...
## Corpus Check
- 210 files · ~57,119 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 836 nodes · 1809 edges · 109 communities (93 shown, 16 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `062869a8`
...
Cohesion: 0.08
Nodes (20): organization(), OrgMember, Permission, DatabaseSeeder, DepartmentSeeder, OrganizationSeeder, PermissionSeeder, RoleSeeder (+12 more)
...
Cohesion: 0.16
Nodes (8): CommentController, SubtaskController, TaskDocumentController, Document, Illuminate\Http\JsonResponse, Illuminate\Http\Request, makeDocumentForList(), makeDocument()
...
Cohesion: 0.12
Nodes (10): AuditTrailController, AuthenticatedSessionController, GoogleAuthController, Controller, DocumentController, NotificationController, OrganizationManagementController, PermissionManagementController (+2 more)

### Community 5 - "Task"
Cohesion: 0.12
Nodes (5): Task, TaskObserver, TaskPolicy, Illuminate\Database\Eloquent\Builder, Illuminate\Database\Eloquent\SoftDeletes
...
### Community 87 - "User"
Cohesion: 0.05
Nodes (14): Collection, User, AuditLogPolicy, CommentPolicy, DepartmentPolicy, DocumentPolicy, OrganizationPolicy, ProjectPolicy (+6 more)

### Community 88 - "Organization"
Cohesion: 0.08
Nodes (9): DepartmentManagementController, StoreDepartmentRequest, AccessPermission, Department, Organization, Illuminate\Database\Eloquent\Relations\HasMany, makeStaffOnDashboard(), makeStaffOnKanban() (+1 more)
...
Cohesion: 0.05
Nodes (14): AuditLog, Comment, Subtask, AuditEventDatabaseNotification, AuditEventMailNotification, CommentObserver, SubtaskObserver, SubtaskPolicy (+6 more)

### Community 101 - "Role"
Cohesion: 0.07
Nodes (10): RoleManagementController, UserManagementController, UpdateRoleRequest, validateCompanyRoles(), validateSuperAdminGrant(), StoreUserRequest, UpdateUserRequest, Role (+2 more)
...
- **Why does `User` connect `User` to `OrgMember`, `Illuminate\Http\RedirectResponse`, `Illuminate\Http\Request`, `LoginRequest`, `Illuminate\View\View`, `Role`, `Task`, `Project`, `NotificationSetting`, `Organization`, `DashboardController.php`, `AuditLog`?**
  _High betweenness centrality (0.139) - this node is a cross-community bridge._
- **Why does `Organization` connect `Organization` to `OrgMember`, `Illuminate\Http\RedirectResponse`, `Illuminate\Http\Request`, `Illuminate\View\View`, `Role`, `Project`, `Priority.php`, `StoreTaskRequest`, `TaskManagementController`, `User`, `DashboardController.php`, `Illuminate\Foundation\Http\FormRequest`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `Task` connect `Task` to `OrgMember`, `Illuminate\Http\RedirectResponse`, `Illuminate\Http\Request`, `Project`, `Priority.php`, `TaskManagementController`, `User`, `DashboardController.php`, `AuditLog`?**
